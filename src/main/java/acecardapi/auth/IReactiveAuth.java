...
public interface IReactiveAuth extends AuthProvider {
   ...
   */
  static ReactiveAuth create(Vertx vertx, PgPool client) {
    return new ReactiveAuth(vertx, client);
  }
   ...
   */
  @Fluent
  ReactiveAuth setAuthenticationQuery(String authenticationQuery);
   ...
   */
  @Fluent
  ReactiveAuth setRolesQuery(String rolesQuery);
   ...
   */
  @Fluent
  ReactiveAuth setPermissionsQuery(String permissionsQuery);
   ...
   */
  @Fluent
  ReactiveAuth setRolePrefix(String rolePrefix);
   ...
   */
  @GenIgnore
  ReactiveAuth setHashStrategy(IHashStrategy strategy);
   ...
   */
  @Fluent
  ReactiveAuth setNonces(JsonArray nonces);
}
